...
const PerfilPage = () => {
  ...
  useEffect(() => {
    const getUser = async () => {
      const { data: { user } } = await supabase.auth.getUser(); // Obtener los datos del usuario actual
...
const handleImageChange = async (event) => {
  ...
  return (
    <div className="relative isolate px-6 pt-14 lg:px-8"> {/* Ajusta el alto para evitar tanto espacio */}
      <div className="flex flex-col md:flex-row md:items-start md:justify-center md:gap-10 mt-10 flex-grow">
        {/* Navbar Lateral */}
